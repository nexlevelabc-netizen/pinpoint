      ...
      <div className="hidden lg:block" style={{ background: 'var(--p-blue)' }}>
        <div className="container-pinpoint flex items-center justify-between h-8">
          ...
          <div className="flex items-center gap-6">
            <a href="mailto:info@pinpointaccounts.com" className="flex items-center gap-1.5 text-xs font-body text-white/90 hover:text-white transition-colors">
              <Mail size={11} /> <span>info@pinpointaccounts.com</span>
            </a>
          </div>
        </div>
      </div>
      ...
      <nav className="container-pinpoint">
        <div className="flex items-center justify-between h-[68px]">
          ...
          <Link to="/" className="flex items-center">
            <img src="images/logo-navbar.png" alt="Pinpoint Finance and Compliance Ltd" className="h-20 w-auto object-contain" />
          </Link>
